...
class AppController {
	...
	getAccounts() {
		return [
			...
			{ name: 'Heroku - 7898', type: 'Lease', description: 'Dell Lease Account', status: 'Active', currentBalance: '$999,999.99', paymentDueAmount: '$999,999.99', paymentDueDate: '06/01/2016' },
